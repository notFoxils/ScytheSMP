...
public class RerollItem extends Item implements InventoryClickActions {
    ...
    @Override
    public void onInvetoryClick(InventoryClickEvent inventoryClickEvent, ItemStack thisItemStack, @Nullable ItemStack itemStackInCursor) {
        changeToRandomItem(inventoryClickEvent, thisItemStack);
    }
}